...
export default function PoliciesPage() {
  return (
    <Layout>
      <h1 className="font-bold text-xl py-2">Cookies Policy</h1>
      ...
      <h1 className="font-bold text-xl py-2">The use of the Cookies</h1>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">Your Choices Regarding Cookies</h1>
      <p>
