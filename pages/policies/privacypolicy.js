...
export default function PrivacyPolicyPage() {
  return (
    <Layout>
      <h1 className="font-bold text-xl py-2">Privacy Policy</h1>
      ...
      <ul>
        <li>
          <p className="pl-5">{`\u25CF`}Email Address</p>
        </li>
        <li>
          <p className="pl-5">{`\u25CF`}First name and last name</p>
        </li>
        <li>
          <p className="pl-5">
      ...
      <h1 className="font-bold text-xl py-2">Children&apos;s Privacy</h1>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">Changes to this Privacy Policy</h1>
      <p>
