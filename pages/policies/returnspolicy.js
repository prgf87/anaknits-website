...
export default function ReturnsPolicyPage() {
  return (
    <Layout>
      <h1 className="font-bold text-xl py-2">Return and Refund Policy</h1>
      <p>Last updated: August 19, 2022</p>
      <p>Thank you for shopping at AnaKnits.</p>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">Your Order Cancellation Rights</h1>
      <p>
      ...
      <ul>
        <li>
          <p>By email: returns@anaknits.com</p>
        </li>
        <li>
          <p>
      ...
      <h1 className="font-bold text-xl py-2">Conditions for Returns</h1>
      <p>
        <u>
      ...
      <ul>
        ...
        <li>The Goods have not been used or damaged in any way</li>
        <li>
          The Goods must have have the corresponding receipt or proof of
          purchase
        </li>
      </ul>
      <p className="pt-2">
        <u>The following Goods cannot be returned:</u>
      </p>
      <ul>
        <li>
      ...
      <h1 className="font-bold text-xl py-2">Gifts</h1>
      <p>
