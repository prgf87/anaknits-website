          ...
          <table className="w-full justify-evenly sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
            <thead className="border border-2">
              <tr className="border border-2">
                <td className="border border-2 p-2">Shipping Method</td>
                <td className="border border-2 p-2">Shipping Cost</td>
                <td className="border border-2 p-2">Delivery Estimate</td>
              </tr>
            </thead>
            <tbody className="border border-2">
              <tr className="border border-2">
                <td className="border border-2 p-2">
                  FedEx Standard/UPS Ground
                </td>
                <td className="border border-2 p-2">Free</td>
                <td className="border border-2 p-2">3-5 business days</td>
              </tr>
              <tr>
                <td className="border border-2 p-2">
                  FedEx 2 days/UPS 2nd day AM
                </td>
                <td className="border border-2 p-2">$15.85</td>
                <td className="border border-2 p-2">2 business days</td>
              </tr>
              <tr>
                <td className="border border-2 p-2">
                  FedEx Overnight/UPS Next Day
                </td>
                <td className="border border-2 p-2">$23.45</td>
                <td className="border border-2 p-2">1 business day</td>
              </tr>
            </tbody>
          </table>
          <p>
