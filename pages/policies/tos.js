...
export default function TermsOfServicePage() {
  return (
    <Layout>
      <h1 className="font-bold text-xl py-2">Terms and Conditions</h1>
      ...
      <h2 className="font-bold text-lg pb-2">Interpretation</h2>
      <p>
      ...
      <h2 className="font-bold text-lg py-2">Definitions</h2>
      ...
      <h1 className="font-bold text-xl py-2">Acknowledgment</h1>
      <p>
      ...
      <p>
        ...
        permit those under 14 to use the Service.
      </p>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">User Accounts</h1>
      <p>
        When You create and account with Us, You must provide Us information
        that is accurate, complete and current at all times. Failure to do so
        constitutes a breach of the Terms, which may result in immediate
        termination Your account on Our Service.
      </p>
      <p>
        You are responsible for safeguarding the password that You use to access
        the Service and for any activitites or actions under Your Password,
      ...
      <h1 className="font-bold text-xl py-2">Copyright Policy</h1>
      <h2 className="font-bold text-lg pb-2">
        Intellectual Property Infringement
      </h2>
      <p>
        We respect he intellectual property rights of others. It is Our policy
        to respond to any claim the Content posted on the Service infringes a
        copyright or other intellectual property infringement of any person.
      </p>
      <p>
        If You are a copyright owner, or authorized on the behalf of one, and
        ...
        copyright agent via email (info@anaknits.com) and include in Your notice
        a detailed desciption of the alleged infringement.
      </p>
      <p>
        You may be held accountable for damages (including costs and
        attorney&apos;s fees) for misrepresenting that any Content is infringing
        Your copyright.
      </p>
      ...
      <p>
        You may submit a notification pursuant to the Digital Millenium
        ...
        <ul>
          ...
          <li className="pl-5">
            ...
            been infringed, including the URL (ie., web page address) of the
          ...
          <li className="pl-5">
            {`\u25CF`}A statement by You, made under penalty of perjury, tht the
            above information in Your notice is accurate and that You are the
            copyright owner of authorized to act on the copyright owner&apos;s
            behalf.
          </li>
        </ul>
      </p>
      <p>
        You can contact our copyright agent via email (info@anaknits.com). Upon
      ...
      <h1 className="font-bold text-xl py-2">Intellectual Property</h1>
      <p>
      ...
      <p>
        Out trademarks and trade dress may not be used in connection with any
        product or service without the prior written consent of the Company.
      </p>
      <h1 className="font-bold text-xl py-2">Your Feedback to Us</h1>
      <p>
        ...
        sub-license, modify and exploit such Feedback without restriction.
      </p>
      <h1 className="font-bold text-xl py-2">Limitatiton of Liability</h1>
      <p>
        Notwithstanding any damages that You might incur, the entire liability
        of the Company and any of its suppliers under any provision of these
        Terms and Your exclusive remedy for all of the foregoing shall be
        limited to the amomunt actually paid by You through the Service or 100
        USD, whichever is the least amount.
      </p>
      <p>
        To the maximum extent permitted ny applicable law, in no event shall the
        Company or its usppliers be liable for any special, incidental, indirect
        ...
        business inerruption, for personal injury, loss of privacy arising out
        ...
        or otherwise in connection with any provision of these Terms), even if
      ...
      <h1 className="font-bold text-xl py-2">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">Termination</h1>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">Governing Law</h1>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">Disputes Resolution</h1>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">For European Union (EU) Users</h1>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h1 className="font-bold text-xl py-2">United States Legal Compliance</h1>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">Severability and Waiver</h1>
      ...
      <h2 className="font-bold text-lg">Waiver</h2>
      <p>
      ...
      <h1 className="font-bold text-xl py-2">Translation Interpretation</h1>
